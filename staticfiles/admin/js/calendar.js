...
'use strict';
{
    ...
    const CalendarNamespace = {
        ...
        monthsOfYearAbbrev: [
            pgettext('abbrev. month Janeiro', 'Jan'),
            pgettext('abbrev. month Fevereiro', 'Feb'),
            pgettext('abbrev. month Março', 'Mar'),
            pgettext('abbrev. month Abril', 'Apr'),
            pgettext('abbrev. month May', 'May'),
            pgettext('abbrev. month Junho', 'Jun'),
            pgettext('abbrev. month Julho', 'Jul'),
            pgettext('abbrev. month Agosto', 'Aug'),
            pgettext('abbrev. month Setembro', 'Sep'),
            pgettext('abbrev. month Outubro', 'Oct'),
            pgettext('abbrev. month Novembro', 'Nov'),
            pgettext('abbrev. month Dezembro', 'Dec')
        ],
        daysOfWeek: [
